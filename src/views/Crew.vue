      ...
      <div class="h-full flex flex-col xl:flex-wrap items-center px-6 md:px-[38.5px] xl:px-[142px] md:mt-10 xl:mt-[76px]">
        ...
        <div class="flex flex-col items-center xl:items-start md:w-[458px] xl:w-[488px] mt-8 md:mt-[60px] xl:mt-[154px] xl:self-start">
          ...
          <div class="md:text-2xl xl:text-[32px] leading-[18px] md:leading-7 xl:leading-[37px] opacity-50
            mt-8 md:mt-0">{{ data.role }}</div>
          <h2 class="text-2xl md:text-[40px] xl:text-[56px] leading-7 md:leading-[46px] xl:leading-[64px]
            mt-2 xl:mt-4 mb-4 xl:mb-[26px] uppercase">{{ data.name }}</h2>
          <p class="w-full max-w-[327px] md:max-w-[520px] xl:max-w-[445px] text-[#D0D6F9] text-center xl:text-left">
            {{ data.bio }}</p>
        </div>
      </div>
    </div>
